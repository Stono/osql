...
var Table = function(options) {
  ...
  var wrap = function(server) {

    server.get('/' + options.table, function(req, res) {
      selectMany()
        .execute()
        .then(function(results) {
          res.send(results);
    ...
    server.get('/' + options.table + '/:id', function(req, res) {
    ...
    server.post('/' + options.table, function(req, res) {
      insert(req.body)
