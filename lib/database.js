...
var CrudDriver = function(opts) {
  var crud = function(which, copts) {
    copts = _.merge({}, copts, { replaceSingleQuotes: true });
    var query = opts.squel[which](copts);
  ...
  var select = function(copts) {
    return crud('select', copts);
  };

  var insert = function(copts) {
    return crud('insert', copts);
  };

  var update = function(copts) {
    return crud('update', copts);
  };

  var deleteItem = function(copts) {
    return crud('delete', copts);
  };
